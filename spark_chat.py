...
class SparkChat(object):
    ...
    def generate_params(self, messages, temperature=0.7, max_tokens=512):
        data = {
            "header": {
                "app_id": self.app_id,
                "uid": "verysmallwoods"
    ...
    def chatCompletionStream(self, messages, temperature=0.7, max_tokens=512):
...
if __name__ == '__main__':
   #以下密钥信息从控制台获取
    ...
    response = lyw_spark.chatCompletionStream(question, temperature= 0.7, max_tokens=512)
