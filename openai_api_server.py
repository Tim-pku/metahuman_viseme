...
from utils_chatglm3 import process_response, generate_chatglm3, generate_stream_chatglm3
from sentence_transformers import SentenceTransformer

from sse_starlette.sse import EventSourceResponse

# Set up limit request time
EventSourceResponse.DEFAULT_PING_INTERVAL = 500

# set LLM path
MODEL_PATH = os.environ.get('MODEL_PATH', 'D:\\chatglm3-6b')
TOKENIZER_PATH = os.environ.get("TOKENIZER_PATH", MODEL_PATH)

# # set Embedding Model path
# EMBEDDING_PATH = os.environ.get('EMBEDDING_PATH', './LLM_model/bge-large-zh-v1.5')
